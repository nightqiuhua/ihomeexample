...
if __name__ == '__main__':
    config = {
        "accountSid":"8a216da86dae9014016dba3f9cbf08a3", # 主账户id,控制台首页获取
        "authToken":"7907c686867b41e782f0ab5d0946b9c3", # 令牌
        "appId":"8a216da86dae9014016dba3f9d0908a9", # 应用id
        "templateId":"1" # 模版id
    }
    phone = '15527927113'  # 手机号，如果是多个手机号用英文的,分割 比如说13200000000,13300000000
    code = '爱你啊' # 验证码
